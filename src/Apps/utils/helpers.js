...
export const OUTLIER = {
    ...
    "一般化過剰": {
        ...
        label: "一般化過剰",
        color: "#0b311b",
        desc: "一部の事例から全体を判断してない？多様なケースを考えてみよう。",
    },
    "前提不明示": {
        icon: "🫥",
        code: "前提不明示",
    ...
    "定義曖昧": {
        ...
        label: "定義曖昧",
        color: "#d6a502",
        desc: "重要な用語の定義が曖昧かも。定義をはっきりさせよう。",
    },
    "循環論法": {
        icon: "🔁",
        code: "循環論法",
    ...
    "確率無視": {
        ...
        label: "確率無視",
        color: "#4d074d",
        desc: "確率を無視してない？リスクとベネフィットのバランスを考えよう。",
    },
    "不明": {
        icon: "❓",
        code: "不明",
